...
public class PowderedSugar extends Ingredient{

    private double conversionFactor = 120.0;
    private String name = "Powdered Sugar";

    public PowderedSugar(){
        super();
    }
    ...
    public PowderedSugar(double conversionFactor, String name) {
        super();
