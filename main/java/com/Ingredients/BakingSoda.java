...
public class BakingSoda extends Ingredient{

    private double conversionFactor = 230.0;
    private String name = "Baking Soda";
    ...
    public BakingSoda(double conversionFactor, String name) {
        super();
